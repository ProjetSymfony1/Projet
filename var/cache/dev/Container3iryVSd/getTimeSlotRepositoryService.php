 ...
 */
class getTimeSlotRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TimeSlotRepository' shared autowired service.
     *
     * @return \App\Repository\TimeSlotRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TimeSlotRepository.php';

        return $container->privates['App\\Repository\\TimeSlotRepository'] = new \App\Repository\TimeSlotRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
