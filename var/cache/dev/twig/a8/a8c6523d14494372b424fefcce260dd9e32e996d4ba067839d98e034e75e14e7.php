...
class __TwigTemplate_24d24271d2b8c5502b551ebffdd3da1ebf402a1a35df96e1da19d18a9901a7fe extends Template
{
    ...
    ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formMsg"]) || array_key_exists("formMsg", $context) ? $context["formMsg"] : (function () { throw new RuntimeError('Variable "formMsg" does not exist.', 9, $this->source); })()), 'form_start');
        echo "

    ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMsg"]) || array_key_exists("formMsg", $context) ? $context["formMsg"] : (function () { throw new RuntimeError('Variable "formMsg" does not exist.', 11, $this->source); })()), "object", [], "any", false, false, false, 11), 'row');
        echo "

    ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formMsg"]) || array_key_exists("formMsg", $context) ? $context["formMsg"] : (function () { throw new RuntimeError('Variable "formMsg" does not exist.', 13, $this->source); })()), "message", [], "any", false, false, false, 13), 'row');
        echo "
    ...
    ";
        // line 17
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formMsg"]) || array_key_exists("formMsg", $context) ? $context["formMsg"] : (function () { throw new RuntimeError('Variable "formMsg" does not exist.', 17, $this->source); })()), 'form_end');
        echo "
...
{% block body %}
    ...
    {{ form_row(formMsg.object) }}

    {{ form_row(formMsg.message) }}
...
{% endblock %}", "user/contact.html.twig", "C:\\xampp1\\htdocs\\chez-gusto\\templates\\user\\contact.html.twig");
    }
}
